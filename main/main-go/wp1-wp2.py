            ...
            if mode != "GUIDED":
                ...
                if state == STATE_INIT:
                    ...
                    if yaw_ok and alt_ok:
                        ...
                        elif time.time() - alt_stable_start > 1.5:  # Stabil selama 1.5 detik
                            log_msg(f"Yaw & Alt stabil (Alt={cur_alt:.2f}m, diff={alt_diff:.2f}m). Mulai maju ke WP2!", "ACTION")
                    ...
                    if cur_lat and cur_lon:
                        ...
                        if dist < 2.0:
                            if use_aruco:
                                ...
                                log_msg(f"Mendekati WP2 (Jarak: {dist:.1f}m). ArUco NONAKTIF. SELESAI SEGMEN.", "ACTION")
                                state = STATE_DONE
                        else:
