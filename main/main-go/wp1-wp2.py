                ...
                if state == STATE_INIT:
                    ...
                    if cur_yaw is not None:
                        ...
                        if diff < 5.0: # Toleransi 5 derajat
                            print(f"✅ Rotasi selesai (selisih {diff:.1f}°). Maju ke GPS WP2...")
                    ...
                    if cur_lat and cur_lon:
                        ...
                        if dist < 2.0:
                            if use_aruco:
                                print(f"✅ Mendekati WP2 (Jarak: {dist:.1f}m). Beralih ke pencarian ArUco!")
                                state = STATE_CENTER_ARUCO
                            else:
                                print(f"✅ Mendekati WP2 (Jarak: {dist:.1f}m). Verifikasi ArUco DINONAKTIFKAN. SELESAI!")
                                state = STATE_DONE
                        else:
